...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(7), __webpack_require__(20)(module)))
...
// import TestiButton from '../components/TestiButton';
...
// EXTERNAL MODULE: ./client/containers/NavigationContainer.jsx
var NavigationContainer = __webpack_require__(21);

// EXTERNAL MODULE: ./client/containers/CardsContainer.jsx
var CardsContainer = __webpack_require__(22);

// CONCATENATED MODULE: ./client/constants/actionTypes.js
var GET_ALL_ITEMS_START = 'GET_ALL_ITEMS_START';
var GET_ALL_ITEMS = 'GET_ALL_ITEMS';
var GET_ALL_ITEMS_ERR = 'GET_ALL_ITEMS_ERR';
var SEARCH = 'SEARCH';
var LOGIN = 'LOGIN';
// CONCATENATED MODULE: ./client/components/TestiButton.jsx


var TestiButton_TestiButton = function TestiButton(props) {
  return react_default.a.createElement("div", {
    id: "testi"
  }, react_default.a.createElement("button", {
    type: "button",
    onClick: props.fetchAllItems
  }, "Testi Button"));
};

/* harmony default export */ var components_TestiButton = (TestiButton_TestiButton);
...
// CONCATENATED MODULE: ./client/actions/actions.js


var actions_fetchItemsStart = function fetchItemsStart() {
  return {
    type: GET_ALL_ITEMS_START
  };
};
var actions_fetchedItems = function fetchedItems(resp) {
  return {
    type: GET_ALL_ITEMS,
    payload: resp
  };
};
var actions_fetchError = function fetchError(err) {
  return {
    type: GET_ALL_ITEMS_ERR,
    payload: err
  };
};
var actions_fetchItemsData = function fetchItemsData() {
  return function (dispatch) {
    dispatch(actions_fetchItemsStart);
    /* Cannot get final name for export "default" in "./node_modules/whatwg-fetch/fetch.js" (known exports: Headers Request Response DOMException fetch, known reexports: ) */ undefined('/allItems').then(function (response) {
      console.log(response);
      dispatch(actions_fetchedItems(response.json()));
    }).catch(function () {
      return dispatch(actions_fetchError);
    });
  };
...
function _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === "object" || typeof call === "function")) { return call; } return MainContainer_assertThisInitialized(self); }
...
var MainContainer_mapStateToProps = function mapStateToProps(store) {
  return {};
};

var MainContainer_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchAllItems: dispatch(actions_fetchItemsData)
  };
};

var MainContainer_MainContainer =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(MainContainer, [{
    ...
    value: function render() {
      return (// <Navigation />
        react_default.a.createElement("div", null, "testin")
      );
    }
  }]);
...
/* harmony default export */ var containers_MainContainer = (connect_connect(MainContainer_mapStateToProps, MainContainer_mapDispatchToProps)(MainContainer_MainContainer));
...
function (_Component) {
  ...
  App_createClass(App, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("div", null, react_default.a.createElement(containers_MainContainer, null));
    }
  }]);
...
var redux_devtools_extension = __webpack_require__(11);
...
// CONCATENATED MODULE: ./client/reducers/cardsReducer.js
...
var cardsReducer_cardsReducer = function cardsReducer() {
...
/* harmony default export */ var reducers_cardsReducer = (cardsReducer_cardsReducer);
// CONCATENATED MODULE: ./client/reducers/index.js


var reducers = Object(redux["combineReducers"])({
  cards: reducers_cardsReducer
});
/* harmony default export */ var client_reducers = (reducers);
// CONCATENATED MODULE: ./client/store.js




var middlweare = Object(redux["applyMiddleware"])(es, Object(redux_devtools_extension["composeWithDevTools"])());
var store_store = Object(redux["createStore"])(client_reducers, middlweare);
/* harmony default export */ var client_store = (store_store);
...
Object(react_dom["render"])(react_default.a.createElement(components_Provider, {
  store: client_store
}, react_default.a.createElement(client_App, null)), document.getElementById('moo'));
